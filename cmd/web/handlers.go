...
import (
	...
	"github.com/lemmyhemmingway/snippetbox/internal/validator"
)
...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.MaxChars(form.Title, 10), "title", "Title cannot be more than 10 characters")
...
func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.Matches(form.Email, validator.EmailRX), "email", "This must be valid email address")
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.Matches(form.Email, validator.EmailRX), "email", "This is not email")
	form.CheckField(validator.NotBlank(form.Password), "password", "This cannot be blank")
	...
	app.sessionManager.Put(r.Context(), "auth_id", id)
...
func (app *application) userLogoutPost(w http.ResponseWriter, r *http.Request) {
	...
	app.sessionManager.Remove(r.Context(), "auth_id")
